...
export default function Header() {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        if(Object.values(searchFilters).includes("")){
            showNotification({text: "Todos los campos con obligatorios", error: true});
            return;
        }
            ...
            <div className="mx-auto container px-6 py-16">
                <div className="flex justify-between items-center">
                    ...
                    <nav className="flex gap-4">
                        ...
                        <NavLink to="/generar" className={({ isActive }) => isActive ? "text-orange-500 uppercase font-bold" : "text-white uppercase font-bold"}>Generar con IA</NavLink>
                    </nav>
                </div>
